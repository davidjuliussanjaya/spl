...
<div class="page-heading">
    <div class="page-title mb-4 pb-3 border-bottom">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3 class="fw-bold mb-1">Buat Laporan Tracer Study</h3>
    ...
    <div class="row">
                ...
                <div class="card-body px-4 pb-4">
                    <form method="GET" action="{{ route('report.download') }}" id="reportForm" target="_blank">
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-lg fw-bold text-white" style="background:#2563EB;border-color:#2563EB;" onmouseover="this.style.background='#1D4ED8'" onmouseout="this.style.background='#2563EB'">
        ...
        <div class="col-12 col-lg-8 mt-4 mt-lg-0">
            ...
            <div class="row g-3 mb-4">
                <div class="col-6">
                    <div class="card border-0 shadow-sm text-center py-3">
                        <div class="card-body">
                            <i class="bi bi-check-circle-fill fs-2 mb-2" style="color:#0F766E;"></i>
                            <h3 class="fw-bold mb-0" style="color:#0F766E;">{{ $totalSurveySelesai }}</h3>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white pt-4 border-0">
                    <h5 class="fw-bold mb-0"><i class="bi bi-info-circle me-2" style="color:#2563EB;"></i>Format Laporan</h5>
                </div>
                <div class="card-body px-4 pb-4">
                    <div class="row g-3">
                        <div class="col-12">
                            <div class="d-flex align-items-start p-3 rounded-3" style="background:#EFF6FF;">
                                <div class="text-white rounded p-2 me-3 flex-shrink-0" style="background:#2563EB;">
                        ...
                        <div class="col-12">
                            <div class="d-flex align-items-start p-3 rounded-3" style="background:#F0FDFA;">
                                <div class="text-white rounded p-2 me-3 flex-shrink-0" style="background:#0F766E;">
                        ...
                        <div class="col-12">
                            <div class="d-flex align-items-start p-3 rounded-3" style="background:#EFF6FF;">
                                <div class="text-white rounded p-2 me-3 flex-shrink-0" style="background:#1D4ED8;">

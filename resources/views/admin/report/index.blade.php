        ...
        <div class="col-12 col-lg-8 mt-4 mt-lg-0">
            ...
            <div class="row g-3 mb-4">
                <div class="col-6">
                    <div class="card border-0 shadow-sm text-center py-3">
                        <div class="card-body">
                            ...
                            <h3 class="fw-bold mb-0">{{ $totalSurveySelesai }}</h3>
                ...
                <div class="col-6">
                    <div class="card border-0 shadow-sm text-center py-3">
                        <div class="card-body">
                            <i class="bi bi-calendar-range-fill text-primary fs-2 mb-2"></i>
                            <h3 class="fw-bold mb-0">{{ $tahunList->count() }}</h3>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white pt-4 border-0">
                    <h5 class="fw-bold mb-0"><i class="bi bi-info-circle me-2 text-primary"></i>Format Laporan</h5>
                </div>
                <div class="card-body px-4 pb-4">
                    <div class="row g-3">
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            <div class="d-flex align-items-start p-3 bg-light rounded-3">
                                <div class="bg-info text-white rounded p-2 me-3 flex-shrink-0">
                        ...
                        <div class="col-12">
                            <div class="d-flex align-items-start p-3 bg-light rounded-3">
                                <div class="bg-success text-white rounded p-2 me-3 flex-shrink-0">

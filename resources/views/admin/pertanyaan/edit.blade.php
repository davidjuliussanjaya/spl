                ...
                <form action="{{ route('pertanyaan.update', $soal->id) }}" method="POST">
                    ...
                    <div class="row g-4 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control modern-input" name="kategori" value="{{ $soal->kategori }}" placeholder="Contoh: Kepemimpinan, Etos Kerja, dll." required>
                        </div>
                            ...
                            <div id="options">
                                @if($soal->jawaban && $soal->jawaban->count() > 0)
                                    ...
                                    <div class="d-flex align-items-center mb-3 option-item">
                                        ...
                                        <input type="number" name="nilai[]" class="form-control modern-input me-2 text-center" style="width: 100px;" placeholder="Nilai" value="{{ $j->nilai }}" title="Bobot Nilai">

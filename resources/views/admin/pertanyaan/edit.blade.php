            ...
            <div class="card-body">
                ...
                <form action="{{ route('pertanyaan.update', $soal->id) }}" method="POST">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-9">
                            <textarea class="form-control" name="question" required>{{ $soal->soal }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-9">
                            <select class="form-select" name="type" id="typeSelect">
                                <option value="radio" {{ $soal->jenis_soal == 'multiple_choice' ? 'selected' : '' }}>
                                    Radio / Multiple Choice
                                </option>
                                <option value="text" {{ $soal->jenis_soal == 'essay' ? 'selected' : '' }}>
                                    Text
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="kode" value="{{ $soal->kode }}">
                        </div>
                    </div>
                        ...
                        <div class="col-md-9">
                            ...
                            <div id="options">
                                ...
                                <div class="d-flex align-items-center mb-2 option-item">
                                    ...
                                    <input type="text" name="jawaban[]" class="form-control me-2"
                                        value="{{ $j->jawaban }}">
                                    <input type="number" name="nilai[]" class="form-control me-2"
                                        style="width:80px" value="{{ $j->nilai }}">
                    ...
                    <!-- BUTTON -->
                    <div class="text-end">
                        <a href="{{ route('pertanyaan') }}" class="btn btn-light-secondary btn-sm">
                            <i class="dripicons-chevron-left"></i> Kembali
                        </a>
                        <button type="submit" class="btn btn-primary btn-sm">
                            <i class="dripicons-checkmark"></i> Update
                        </button>
                    </div>

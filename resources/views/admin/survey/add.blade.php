                ...
                <div class="card-body p-4">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-4">
                            ...
                            <input type="text" name="judul" class="form-control line-input fs-5" placeholder="Contoh: Survey Kepuasan Pengguna Lulusan 2026" required value="{{ old('judul') }}">
                        </div>

                        <div class="col-md-12 mb-2">
                            <label class="form-label small text-secondary mb-1 fw-bold text-uppercase">Deskripsi / Instruksi Tambahan (Opsional)</label>
                            <textarea name="deskripsi" class="form-control modern-textarea" rows="3" placeholder="Tambahkan deskripsi atau instruksi pengisian survey untuk perusahaan...">{{ old('deskripsi') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-6 border-end-lg">
                ...
                <div class="mb-3">
                    ...
                    {{-- Hapus readonly --}}
                    <input type="text" name="nama" class="form-control line-input" placeholder="Otomatis terisi atau ketik manual...">
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        {{-- Hapus readonly --}}
                        <input type="text" name="hp" class="form-control line-input" placeholder="Otomatis terisi atau ketik manual...">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label small text-secondary mb-1">Email</label>
                        {{-- Hapus readonly --}}
                        <input type="email" name="email" class="form-control line-input" placeholder="Otomatis terisi atau ketik manual...">
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="mb-3">
                    ...
                    <select name="pengguna_lulusan_id" id="select_perusahaan" class="form-select line-input" required>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        {{-- Hapus readonly --}}
                        <input type="text" name="badan_hukum" class="form-control line-input" placeholder="Otomatis terisi atau ketik manual...">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label small text-secondary mb-1">Telepon Kantor</label>
                        {{-- Hapus readonly --}}
                        <input type="text" name="telp_perusahaan" class="form-control line-input" placeholder="Otomatis terisi atau ketik manual...">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    {{-- Hapus readonly --}}
                    <input type="text" name="alamat_perusahaan" class="form-control line-input" placeholder="Otomatis terisi atau ketik manual...">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white pt-4 px-4 border-0">
                    ...
                    <p class="text-muted small ms-5 ps-2">Centang pertanyaan yang akan muncul di halaman survey perusahaan.</p>
                </div>

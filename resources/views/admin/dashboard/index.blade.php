    ...
    <div class="page-title mb-4 pb-3 border-bottom">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center">
            <div>
                ...
                <p class="text-muted mb-0 small">Ringkasan performa dan kualitas lulusan Universitas Dinamika di dunia kerja.</p>
            </div>
                ...
                <div class="card-body px-4 py-4-5">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-8 col-12 text-center text-md-start">
                            ...
                            <h4 class="font-extrabold mb-0 text-dark">{{ $totalSurvey ?? 0 }} <span class="fs-6 fw-normal text-muted">Instansi</span></h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body px-4 py-4-5">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-8 col-12 text-center text-md-start">
                            ...
                            <h4 class="font-extrabold mb-0 text-dark">{{ $totalLulusan ?? 0 }} <span class="fs-6 fw-normal text-muted">Orang</span></h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body px-4 py-4-5">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-8 col-12 text-center text-md-start">
                            ...
                            <h4 class="font-extrabold mb-0 text-success">{{ number_format($rataKeseluruhan ?? 0, 2) }} <span class="fs-6 fw-normal text-muted">/ 4.00</span></h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body px-4 py-4-5">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-8 col-12 text-center text-md-start">
                            ...
                            <h6 class="font-bold mb-0 text-dark text-truncate" title="{{ $kategoriTerbaik->kategori ?? '-' }}">{{ $kategoriTerbaik->kategori ?? '-' }}</h6>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="alert alert-success border-0 shadow-sm mb-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="mb-0 small text-dark">Lulusan sangat unggul pada aspek <strong>{{ $kategoriTerbaik->kategori ?? '-' }}</strong> dengan skor {{ number_format($kategoriTerbaik->rata_rata ?? 0, 2) }}.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="alert alert-danger border-0 shadow-sm">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="mb-0 small text-dark">Aspek <strong>{{ $kategoriTerlemah->kategori ?? '-' }}</strong> perlu perbaikan, dengan skor terendah {{ number_format($kategoriTerlemah->rata_rata ?? 0, 2) }}.</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-hover table-borderless mb-0">
                            ...
                            <tbody>
                                @forelse($komentarTerbaru as $komen)
                                    <tr>
                                        <td class="ps-4">
                                            <p class="font-bold mb-0 text-dark">{{ $komen->survey->pengguna_lulusan->nama_perusahaan ?? 'Anonim' }}</p>
                                            <small class="text-muted">{{ $komen->responden ?? '-' }}</small>
                                        </td>
                                        <td>
                                            <span class="badge bg-light text-secondary border text-wrap text-start" style="max-width: 250px;">{{ $komen->soal->soal ?? 'Essay' }}</span>
                                        </td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="3" class="text-center py-4 text-muted">Belum ada umpan balik kualitatif dari instansi.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
